...
var Missile_Direction_X = 0.00
var Missile_Direction_Y = -0.02

var centerTank_X = 0.8;
var centerTank_Y = 0.35;
...
function render() {
	...
	var vertices_hull = new Float32Array(
		[
			0.9, 0.5, 0.9, 0.2, 0.7, 0.2, 0.9, 0.5, 0.7, 0.2, 0.7, 0.5
		]);
	...
	var vertices_turret = new Float32Array(
		[
			0.85, 0.4, 0.85, 0.3, 0.75, 0.3, 0.85, 0.4, 0.75, 0.3, 0.75, 0.4,
			0.79, 0.3, 0.79, 0.05, 0.81, 0.05, 0.79, 0.3, 0.81, 0.05, 0.81, 0.3
		]);
